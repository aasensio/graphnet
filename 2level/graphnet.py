...
class EncodeProcessDecode(nn.Module):
    def __init__(self, node_input_size, edge_input_size, global_input_size, latent_size, mlp_hidden_size, mlp_n_hidden_layers, n_message_passing_steps, output_size):
        ...
        # We define the MLP that will encode the node/edge properties into a latent space
        ...
        # We define the final MLP that projects the latent space in the nodes into the desired output size
        ...
        # The processor networks update the value in the nodes and edges using message passing
        # For that we use the MetaLayer of Torch Geometric
